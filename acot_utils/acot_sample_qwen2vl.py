...
def sample(
    ...
    **model_kwargs,
    ...
    if use_cd1:
        ...
        input_ids_cd1 = copy.deepcopy(model_kwargs_cd1.get('input_ids_cd1',None))
        # model_kwargs_cd1['input_ids']= model_kwargs_cd1.get('input_ids_cd1',None)
        model_kwargs_cd1['attention_mask'] = torch.ones(model_kwargs_cd1['input_ids_cd1'].shape[:2]).to(model_kwargs_cd1['input_ids_cd1'].device)
        if model_kwargs_cd1.get('attention_mask_cd1',None) != None:
            model_kwargs_cd1['attention_mask'] = model_kwargs_cd1['attention_mask_cd1']
        model_kwargs_cd1 = self._get_initial_cache_position(input_ids_cd1, model_kwargs_cd1)
        model_kwargs_cd1['cache_position'] = model_kwargs_cd1['cache_position'].cpu()
    
    if use_cd2:
        model_kwargs_cd2 = copy.deepcopy(model_kwargs)
        input_ids_cd2 = copy.deepcopy(model_kwargs_cd1.get('input_ids_cd2',None))
        # model_kwargs_cd2['input_ids']= model_kwargs_cd2.get('input_ids_cd2',None)
        model_kwargs_cd2['attention_mask'] = torch.ones(model_kwargs_cd2['input_ids_cd2'].shape[:2]).to(model_kwargs_cd2['input_ids_cd2'].device)
        if model_kwargs_cd2.get('attention_mask_cd2',None) != None:
            model_kwargs_cd2['attention_mask'] = model_kwargs_cd2['attention_mask_cd2']
        model_kwargs_cd2 = self._get_initial_cache_position(input_ids_cd2, model_kwargs_cd2)
        model_kwargs_cd2['cache_position'] = model_kwargs_cd2['cache_position'].cpu()
        
    if use_cd3:
        model_kwargs_cd3 = copy.deepcopy(model_kwargs)
        input_ids_cd3 = copy.deepcopy(model_kwargs_cd1.get('input_ids_cd3',None))
        # model_kwargs_cd3['input_ids']= model_kwargs_cd3.get('input_ids_cd3',None)
        model_kwargs_cd3['attention_mask'] = torch.ones(model_kwargs_cd3['input_ids_cd3'].shape[:2]).to(model_kwargs_cd3['input_ids_cd3'].device)
        if model_kwargs_cd3.get('attention_mask_cd3',None) != None:
            model_kwargs_cd3['attention_mask'] = model_kwargs_cd3['attention_mask_cd3']
        model_kwargs_cd3 = self._get_initial_cache_position(input_ids_cd3, model_kwargs_cd3)
        model_kwargs_cd3['cache_position'] = model_kwargs_cd3['cache_position'].cpu()

    model_kwargs = self._get_initial_cache_position(input_ids, model_kwargs)
    model_kwargs['cache_position'] = model_kwargs['cache_position'].cpu()
