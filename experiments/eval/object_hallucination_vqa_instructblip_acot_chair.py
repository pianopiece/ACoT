...
def eval_model(args):
    ...
    try:
        with open('./cache_dic1_blip_chair.json','r') as f:
            cache_dic1 = json.load(f)
        with open('./cache_dic2_blip_chair.json','r') as f:
            cache_dic2 = json.load(f)
        with open('./cache_dic3_blip_chair.json','r') as f:
    ...
    for line in tqdm(questions):
        ...
        print(outputs)
    with open('cache_dic1_blip_chair.json', 'w') as file:
        json_data = json.dumps(cache_dic1)
        file.write(json_data)
    with open('cache_dic2_blip_chair.json', 'w') as file:
        json_data = json.dumps(cache_dic2)
        file.write(json_data)
    with open('cache_dic3_blip_chair.json', 'w') as file:
