...
def eval_model(args):
    ...
    for line in tqdm(questions):
        ...
        if args.use_cd1:
            ...
            conversation_cd1.append({"role": "user", "content":[{'text': qs + " Please answer this question with one word."}]})
        ...
        if args.use_cd2:
            ...
            conversation_cd2.append({"role": "user", "content":[{'text': qs + " Please answer this question with one word."}]})
        ...
        if args.use_cd3:
            ...
            conversation_cd3.append({"role": "user", "content":[{'text': qs + " Please answer this question with one word."}]})
