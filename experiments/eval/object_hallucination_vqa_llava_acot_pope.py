...
def eval_model(args):
    ...
    try:
        with open('./cache_dic1.json','r') as f:
            cache_dic1 = json.load(f)
        with open('./cache_dic2.json','r') as f:
            cache_dic2 = json.load(f)
        with open('./cache_dic3.json','r') as f:
    ...
    for line in tqdm(questions):
        ...
        if args.use_cd1:
            ...
            conv_cd1.append_message(conv_cd1.roles[0], cur_prompt + " Please answer this question with one word.")
            conv_cd1.append_message(conv_cd1.roles[1], None)
        ...
        if args.use_cd2:
            ...
            conv_cd2.append_message(conv_cd2.roles[0], cur_prompt + " Please answer this question with one word.")
            conv_cd2.append_message(conv_cd2.roles[1], None)
        ...
        if args.use_cd3:
            ...
            conv_cd3.append_message(conv_cd3.roles[0], cur_prompt + " Please answer this question with one word.")
            conv_cd3.append_message(conv_cd3.roles[1], None)
        ...
        ans_file.write(json.dumps({"question_id": idx,
                                   ...
                                   "metadata": {}}) + "\n")
        ans_file.flush()
    with open('cache_dic1.json', 'w') as file:
        json_data = json.dumps(cache_dic1)
        file.write(json_data)
    with open('cache_dic2.json', 'w') as file:
        json_data = json.dumps(cache_dic2)
        file.write(json_data)
    with open('cache_dic3.json', 'w') as file:
